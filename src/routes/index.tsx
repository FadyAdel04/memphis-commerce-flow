...
<div className="absolute top-1/2 left-1/2 w-[150%] -translate-x-1/2 -translate-y-1/2 bg-tertiary-fixed border-y-2 border-on-surface py-space-xs overflow-hidden select-none -rotate-[20deg] shadow-[0_6px_0_#111c2d]">
